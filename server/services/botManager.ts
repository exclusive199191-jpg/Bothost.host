      ...
      client.on('messageCreate', async (message: any) => {
        ...
        if (command === 'ab') {
            ...
            const abLines = [
                ...
                'ur cooked retard',
                'slut nobody asked',
                'degen get off the app',
                'foid ur irrelevant',
                'whore shut ur mouth',
                'ur slow as hell idiot',
                'kys no cap',
                'retard log off g',
                'moid nobody rates u',
                'slut stfu fr',
                'ur a foid lmao',
                'degen move around bro',
                'idiot ur not it',
                'whore get off me',
                'kys retard',
                'foid nobody wants u here',
                'ur a slut and a degen',
                'moid shut up already',
                'retard ur cooked',
                'degen stfu and leave',
                'slut log off forever',
                'ur an idiot fr',
                'whore nobody clocked u',
                'foid ur mid as hell',
                'kys moid',
                'retard move around',
                'degen ur embarrassing',
                'slut pipe down',
                'idiot sit down',
                'moid ur a loser',
                'foid stfu nobody asked',
                'whore ur slow wtf',
                'kys degen fr',
                'retard ur not a factor',
                'slut get off the server',
                'degen idiot combo',
                'moid log off and cry',
                'foid ur nothing g',
                'whore shut it',
                'kys and stay gone',
                'idiot ur embarrassing urself',
                'retard degen energy smh',
                'slut nobody rates u here',
                'moid ur cooked no revive',
                'foid move around gang',
                'whore ur a whole L',
                'degen stfu ur slow',
                'kys idiot',
                'retard get off the app',
                'slut ur irrelevant fr',
                'moid nobody wants ur input',
                'foid ur a degen whore',
                'idiot log off rn',
                'whore shut up and leave',
                'retard ur not built for this',
                'degen foid get out',
                'kys slut',
                'moid ur mid as hell',
                'foid idiot combo lmao',
                'slut move around already',
                'whore ur cooked bro',
                'retard stfu nobody cares',
                'degen ur a whole nobody',
                'kys moid fr',
                'idiot ur embarrassing',
                'foid slut log off',
                'moid get off me g',
                'whore nobody asked u',
                'retard ur slow af',
                'degen kys no debate',
                'slut ur not it at all',
                'foid move around retard',
                'idiot shut ur app',
                'moid ur a degen fr',
                'whore log off and stay gone',
                'kys idiot no cap',
                'retard ur a slut fr',
                'degen moid combo smh',
                'foid nobody rates u',
                'slut ur cooked',
                'whore stfu already',
                'moid ur a loser retard',
                'idiot get off the app g',
                'kys foid',
                'retard ur irrelevant',
                'degen slut shut up',
                'moid ur not a factor',
                'whore move around bro',
                'foid kys fr',
                'slut ur a whole degen',
                'idiot nobody asked',
                'retard log off and reflect',
                'degen ur cooked with no revive',
                'moid slut combo',
                'whore shut it nobody cares',
                'kys retard on sight',
                'foid ur mid and u know it',
                'slut idiot get out',
                'degen move around whore',
                'moid ur embarrassing fr',
                'retard kys already',
                'foid nobody wants u here',
                'whore ur a degen retard',
                'idiot log off',
                'slut ur slow as hell',
                'kys degen moid',
                'foid stfu ur cooked',
                'moid whore shut up',
                'retard ur not built for this convo',
                'degen idiot move around',
                'slut get off the server',
                'whore ur irrelevant no cap',
                'kys foid fr',
                'moid ur a whole L',
                'idiot retard log off',
                'foid slut nobody asked',
                'degen ur nothing g',
                'whore kys already',
                'slut moid get out',
                'retard ur embarrassing urself',
                'kys idiot and stay gone',
                'foid degen combo lmao',
                'moid shut ur app',
                'whore ur cooked bro',
                'idiot nobody rates u here',
                'slut log off forever',
                'degen retard move',
                'foid ur slow wtf',
                'kys moid on sight',
                'whore stfu and leave',
                'moid ur a degen slut',
                'retard get off me',
                'idiot ur mid fr',
                'slut foid shut up',
                'degen whore log off',
                'kys retard no debate',
                'foid moid combo smh',
                'moid ur not a factor g',
                'whore idiot sit down',
                'slut ur cooked no revive',
                'retard degen get out',
                'idiot ur embarrassing',
                'foid kys slut',
                'kys whore fr',
                'degen moid nobody asked',
                'moid ur a retard fr',
                'slut nobody wants u',
                'whore ur irrelevant',
                'retard log off and cry',
                'idiot ur a whole degen',
                'foid shut it nobody cares',
                'kys degen slut',
                'moid ur cooked',
                'whore stfu already g',
                'slut retard move around',
                'degen foid get off the app',
                'idiot ur slow as hell',
                'foid ur a moid retard',
                'kys slut on sight',
                'moid whore log off',
                'retard ur not it',
                'slut degen shut up',
                'whore nobody rates u here',
                'idiot move around bro',
                'foid ur embarrassing fr',
                'kys moid idiot',
                'degen ur a whole nobody',
                'moid slut get out',
                'whore ur mid as hell',
                'retard stfu ur cooked',
                'slut foid log off forever',
                'idiot kys no cap',
                'foid degen whore',
                'kys retard already',
                'moid ur irrelevant fr',
                'whore nobody asked u',
                'slut ur not built for this',
                'degen retard combo lmao',
                'idiot get off the server',
                'foid moid shut up',
                'kys whore and stay gone',
                'moid ur a degen fr',
                'whore idiot log off',
                'slut ur slow wtf',
                'retard foid move around',
                'degen kys on sight',
                'idiot ur cooked no revive',
                'foid slut nobody wants u',
                'kys moid no debate',
                'moid ur embarrassing',
                'whore retard sit down',
                'slut degen get out',
                'idiot ur a whole L',
                'foid kys already',
                'degen whore log off rn',
                'moid nobody rates u',
                'retard ur not a factor',
                'slut idiot shut ur app',
                'kys foid fr',
                'whore moid combo smh',
                'idiot ur mid and cooked',
                'foid retard move',
                'degen slut stfu',
                'moid whore get off me',
                'kys idiot on sight',
                'slut ur irrelevant no cap',
                'retard log off degen',
                'foid ur a slut whore',
                'whore kys moid',
                'idiot nobody cares',
                'moid foid shut it',
                'slut retard log off',
                ...
                'kys whore fr no cap',
                'foid idiot move around',
                'moid ur cooked bro',
                'whore slut nobody asked',
                'retard degen get off the app',
                'idiot foid log off forever',
                'slut kys already g',
                'degen moid ur slow af',
                'kys retard degen',
                'foid whore shut up',
                'moid ur a whole nobody',
                'whore idiot ur not it',
                'slut foid nobody wants u here',
                'retard kys on sight',
                'idiot degen combo',
                'foid slut get out',
                'moid ur irrelevant fr',
                'whore retard move around',
                'kys idiot no debate',
                'degen foid shut it',
                'slut moid ur cooked',
                'foid kys whore',
                'moid degen log off',
                'retard ur a slut idiot',
                'whore nobody rates u here',
                'idiot ur mid fr',
                'slut kys moid',
                'kys foid degen',
                'degen whore stfu',
                'moid retard sit down',
                'foid slut move around',
                'whore kys already',
                'idiot ur embarrassing urself',
                'slut degen nobody asked',
                'retard foid log off',
                'kys moid whore',
                'moid ur a degen retard',
                'degen slut get off the server',
                'foid idiot shut ur app',
                'whore ur cooked no revive',
                'idiot kys fr',
                'slut retard ur not built for this',
                'moid foid combo lmao',
                'kys degen whore',
                'retard ur a whole L',
                'foid moid nobody cares',
                'whore slut log off rn',
                'degen idiot move',
                'slut kys on sight',
                'moid ur irrelevant degen',
                'foid whore ur slow wtf',
                'idiot retard shut up',
                'kys slut fr',
                'whore degen get out',
                'moid idiot nobody rates u',
                'foid ur embarrassing',
                'slut whore log off forever',
                'retard kys already degen',
                'degen foid ur not a factor',
                'kys moid idiot fr',
                'moid slut nobody wants u',
                'whore retard move around',
                'idiot foid shut it',
                'foid kys degen slut',
                'slut ur mid and cooked bro',
                'degen moid get off me',
                'kys whore retard',
                'moid ur a whole nobody',
                'whore idiot log off',
                'retard slut degen',
                'foid nobody asked u',
                'idiot kys moid',
                'slut ur irrelevant g',
                'degen whore shut up',
                'moid foid ur cooked',
                'kys retard slut',
                'whore ur not it at all',
                'foid degen log off rn',
                'moid idiot combo smh',
                'slut retard get out',
                'idiot kys whore',
                'degen ur a slut foid',
                'kys moid fr on sight',
                'foid slut nobody rates u',
                'whore moid log off forever',
                'retard ur embarrassing urself',
                'moid degen kys already',
            ];
