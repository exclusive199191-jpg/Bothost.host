      ...
      client.on('messageCreate', async (message: any) => {
        ...
        if (command === 'ab') {
            ...
            const abLines = [
                ...
                'move around bro nobody clocked u',
                'ur the definition of a random',
                'bro u type slow AND say nothing',
                'ur not even a factor g',
                'gang ur so irrelevant its sad',
                'u been a dork ur whole life huh',
                'nobody is checking for u bro',
                'ur whole vibe is a L',
                'u actually thought u had something to say',
                'bro sit down and think about ur life',
                'ur giving degen from the jump',
                'nobody brought u into this convo g',
                'u are not the one bro at all',
                'gang log off and go sleep',
                'ur opinion expired before u sent it',
                'bro ur whole thing is embarrassing',
                'u are a certified nobody g',
                'stop acting like u matter here',
                'ur so cooked rn and u dont even know',
                'bro u got no game no chat no wins',
                'ur a random with random energy move',
                'gang u been getting cooked this whole time',
                'nobody here is scared of ur typing bro',
                'u been losing since u opened the app',
                'ur lowk slow in more ways than one',
                'bro delete the app and start fresh',
                'u are genuinely not built for this',
                'gang shut ur app and go outside',
                'nobody claps for degens bro',
                'ur energy is all wrong g',
                'bro u aint even a blip on the radar',
                'u talk a lot for someone with zero W s',
                'gang ur so dry its painful to read',
                'bro every message is a new L for u',
                'u genuinely got nothing going for u rn',
                'ur a whole dork and u wear it proudly',
                'bro log off ur making it worse',
                'gang u been embarrassing urself for free',
                'nobody brought u here so move around',
                'ur chat is giving 0 iq every time',
                'bro u are not the vibe at all',
                'go find a different server g seriously',
                'ur literally a waste of screen space',
                'bro u type so much and say so little',
                'u got big mouth energy with nothing to back it',
                'gang u are cooked with no revive',
                'ur whole fit is giving loser',
                'bro nobody is rating ur input',
                'u been getting aired out this whole time',
                'gang shut up and sit down for real',
                'ur slow and ur proud about it thats wild',
                'bro u are a background character at best',
                'u got the confidence of someone who has never won',
                'gang ur embarrassing and u dont even see it',
                'nobody asked u to speak bro',
                'ur giving class clown but without the funny',
                'bro u are genuinely not it',
                'gang move around ur a whole nobody',
                'u out here beefing with ur whole chest for nothing',
                'bro ur a degen through and through',
                'u are not the main character g',
                'gang ur mid and everyone here knows it',
                'bro stop talking ur actually hurting urself',
                'u been on L season the whole convo',
                'gang ur not even a challenge bro',
                'nobody rates a dork who beefs online',
                'ur so slow u probably type with one finger',
                'bro u are the definition of a random',
                'u think ur sharp but ur genuinely blunt g',
                'gang the whole server clocked u already',
                'ur not even a speedbump bro move',
                'u got participation energy in a finals convo',
                'bro nobody is gonna remember this L u taking',
                'gang ur a certified dork no debate',
                'u are genuinely below average and it shows',
                'bro u came here to lose and ur winning at that',
                'nobody here is vibing with ur energy g',
                'ur so random it actually loops back to funny',
                'bro pack it up ur done here',
                'u got zero range bro ur so one-note',
                'gang u are cooked stewed and finished',
                'ur honestly just a background degen',
                'bro u are not a threat ur a footnote',
                'u been taking Ls since u got here',
                'gang get off the app and go think',
                'ur the type of person who loses every argument',
                'bro u brought nothing to this convo but cringe',
                'u are a placeholder in every server u join',
                'gang ur giving loser at an olympic level',
                'nobody is gonna vouch for u bro',
                'ur so dry u make the convo worse by being here',
                'bro u are a charity case in this beef',
                'u got internet muscles and no follow through',
                'gang ur chat history is just L after L',
                'ur genuinely not a factor move around',
                'bro u are the weakest link and everyone sees it',
                'u talk big for someone who has done nothing',
                'gang stop embarrassing urself for free',
                'ur a whole side character trying to be the main',
                'bro u are not it was never it and will never be it',
                'u got one setting and its loser g',
                'gang ur so mid u blend into the background',
                'nobody here is on ur level because ur at the bottom',
                'bro u brought degen energy to a real convo',
                'u are the reason people mute channels',
                'gang go lay down ur giving migraine energy',
                'ur so cooked u dont even know the stove is on',
                'bro u are genuinely a waste of a username',
                'u been getting bodied and u keep going wild',
                'gang ur not even a bump in the road bro',
                'nobody is hyping u up here so fall back',
                'ur the type to talk first and think never',
                'bro u are a degen who peaked in the chat box',
                'u got the range of a broken remote g',
                'gang ur irrelevant and its not even close',
                'ur a bottom feeder in every convo bro',
                'bro u are so slow the wifi feels bad for u',
                'u think ur cold but ur room temperature at best',
                'gang u are a walking nothing bro',
                'nobody is losing sleep over ur words g',
                'ur giving fake deep but its actually just shallow',
                'bro u are background noise in this server',
                'u got a big ego for someone with zero clout',
                'gang ur a whole dork with a dork mindset',
                'nobody claps for performances like urs bro',
                'ur so mid ur whole presence is optional',
                'bro u come here every time to lose',
                'u are genuinely the least interesting person here',
                'gang go touch grass and then stay outside',
                'ur chat is giving zero effort zero results',
                'bro u are a charity beef nobody asked for',
                'u got the confidence of someone who has never been checked',
                'gang ur so cooked its actually sad to watch',
                'nobody is rating u bro u are not the one',
                'ur giving loser with a capital L every message',
                'bro u are a degen in hibernation mode',
                'u been on the wrong side of every exchange here',
                'gang log off shower eat and reflect',
                'ur whole thing is giving zero substance bro',
                'u are the definition of mid and nothing else',
                'gang ur not even an afterthought bro ur nothing',
                'bro u came to beef and got mopped instead',
                'u got participation trophy energy in a winner convo',
                'gang ur giving clown but without the entertainment',
                'nobody here is on ur frequency g',
                'ur so slow u probably still loading bro',
                'bro u are an NPC in a server full of players',
                'u got the presence of someone nobody invited',
                'gang ur a whole joke and the punchline is ur username',
                'nobody vouches for degens who cant back it up',
                'ur genuinely below the bar and the bar is on the floor',
                'bro u are a permanent member of L town',
                'u been losing every exchange and u keep fighting',
                'gang that effort was embarrassing and u know it',
                'ur a dork with a wi-fi connection thats it',
                'bro u are not a player ur a pawn',
                'u got zero facts zero game zero wins g',
                'gang ur the kind of person servers go quiet for',
                'nobody clocked u when u arrived and nobody will miss u',
                'ur so random u dont even have a category',
                'bro u are the background character of background characters',
                'u got big talk energy but small chat results',
                'gang ur genuinely not built for this convo',
                'ur a whole degen and ur proud of it smh',
                'bro u type paragraphs to say absolutely nothing',
                'u are the least intimidating person in here by far',
                'gang go read a book and come back smarter',
                'nobody is here for ur energy bro seriously',
                'ur so cooked the whole kitchen is on fire',
                'bro u are a cautionary tale with a pfp',
                'u got zero credibility in this convo g',
                'gang ur a dork with delusions move around',
                'nobody asked for ur take and nobody needed it',
                'ur giving grade school beef in a grown convo',
                'bro u are not an asset ur a liability',
                'u been a sideline player ur whole online career',
                'gang sit down bro ur not even close to the level',
                'ur a random with an opinion nobody ordered',
                'bro u are so forgettable this convo will outlive ur memory',
                'u got the audacity of someone who has nothing to lose',
                'gang ur giving poverty mindset in every message',
                'nobody is clapping for u bro not even close',
                'ur whole vibe is a cry for attention and nobody is answering',
                'bro u are genuinely a walking L no revive available',
                'u been embarrassing and ur not even aware',
                'gang go outside before u make this worse',
                'ur so mid ur messages are loading indicators',
                'bro u are a degen through and through no question',
                'u got nothing g literally zero substance',
                'gang ur not even a challenge ur a formality',
                'nobody is rating ur words bro stop sending them',
                'ur giving desperate energy and its not a good look',
                'bro u are the last pick in every team and it shows',
                'u been getting aired out since message one',
                'gang ur a certified dork please accept it',
                'nobody claps for u at home either bro',
                'ur so cooked u cannot be saved by anyone',
                'bro u are not a vibe ur a virus in the server',
                'u got keyboard courage and nothing else g',
                'gang ur embarrassing and everyone clocked it',
                'nobody is here for ur brand of degen energy',
                'ur a whole clown and the circus left without u',
                'bro u are giving off energy so negative it crashes servers',
                'u been on the wrong team since jump bro',
                'gang go get some wins in real life first',
                'ur so slow the message loaded before ur brain did',
                'bro u are not relevant now or ever',
                'u got participation energy in an elimination round',
                'gang ur a whole footnote in this convo',
                'nobody needed ur comment and nobody wants it',
                'ur giving big dork in every single line',
                'bro u are a minus in every group u join',
                'u been taking damage this whole time and still going',
                'gang go log off and come back as someone different',
                'ur not a threat ur a temperature check',
                'bro u are so cooked even the smoke is embarrassed',
                'u got zero traction bro zero',
                'gang ur giving loser who doesnt know hes losing',
                'nobody is on ur side because ur not worth siding with',
                'ur a whole degen with a Wi-Fi connection and too much time',
                'bro u are not built different ur just built wrong',
                'u been getting checked since u opened ur mouth',
                'gang log off take a walk touch some grass',
                'ur so random nobody knows why ur even here',
                'bro u are giving energy of someone who loses board games',
                'u got audacity without the talent to back it g',
                'gang ur a permanent resident of L city bro',
                'nobody rates a dork who types fast but thinks slow',
                'ur whole existence in this server is a red flag',
                'bro u are a degen on autopilot',
                'u been saying nothing at top speed the whole time',
                'gang go away and take ur energy with u',
                'ur so mid u make average look ambitious',
                'bro u are not the problem u are the problem AND the solution is ur absence',
                'u got the impact of a typo in a long message g',
                'gang ur a walking participation trophy bro',
                'nobody is impressed by u and nobody ever will be',
                'ur giving clown core with every message u send',
                'bro u are the weakest person in this convo by a mile',
                'u been a dork for so long it became ur personality',
                'gang ur not even close bro fall way back',
                'nobody clocked ur arrival and nobody will notice ur exit',
                'ur a whole charity case of a debater',
                'bro u are cooked medium well and still going',
                'u got big I m not a loser energy but the data says otherwise',
                'gang ur not in the game ur in the parking lot',
                'nobody rates a person who types paragraphs to say nothing',
                'ur so irrelevant even the algorithm skips u',
                'bro u are a whole degen with a speech problem',
                'u been getting bodied and calling it progress',
                'gang go reflect on every message u sent here today',
                'ur giving try hard with zero results bro',
                'nobody is rooting for u in this convo g',
                'ur a random with a vendetta and no wins to show for it',
                'bro u are not a danger ur a distraction',
                'u got the confidence of a person who has never been humbled',
                'gang ur a certified L magnet bro',
                'nobody is hyping this up for u so stop waiting',
                'ur so dry the conversation dehydrates when u type',
                'bro u are giving loser at a professional level now',
                'u been here the whole time and added nothing',
                'gang go somewhere else and bring that energy there',
                'ur a whole degen ambassador and nobody elected u',
                'bro u are genuinely the bottom of the barrel',
                'u got nothing to bring to the table g literally nothing',
                'gang ur a placeholder where a real person should be',
                'nobody wants ur input and the thread proves it',
                'ur giving off energy that makes the whole chat worse',
                'bro u are an NPC who thinks hes the protagonist',
                'u been embarrassing urself since message one bro',
                'gang ur so cooked u dont even realize the heat',
                'nobody clapped for u because nobody ever will',
                'ur a whole dork trying to run in a sprinters race',
                'bro u are not built for this level of convo at all',
                'u got zero substance and unlimited confidence somehow',
                'gang go eat and log off u need the energy elsewhere',
                'ur so mid u are genuinely the average of all averages',
                'bro u are giving off I lose online for fun energy',
                'u been a degen this whole conversation no debate',
                'gang nobody is moved by ur messages bro not even a little',
                'ur giving keyboard warrior who has never won a fight',
                'bro u are a certified random with a certified big mouth',
                'u got the chat history of someone who needs a new hobby',
                'gang ur not doing damage ur doing cardio in the wrong direction',
                'nobody is rating this energy bro seriously log off',
                'ur so cooked u came out the other side as ash',
                'bro u are the definition of a dork who doesnt know hes a dork',
                'u been saying everything and meaning nothing the whole time',
                'gang move around for real ur time is done here',
            ];
